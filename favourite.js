    ...
    wishlist.forEach((product, index) => {
      ...
      <div class="wishlist-item">
        ...
        <div class="wishlist-quantity">
          ...
          <button class="movebutton" onclick="moveToWishlist(${index})">MOVE TO WISHLIST</button>
          </div>
      </div>
    `;
    });
...
function calculateTotal() {
    var cartItems = JSON.parse(localStorage.getItem(favoritesStorageKey)) || [];
    var totalAmount = 0;
    var donation = 0;
